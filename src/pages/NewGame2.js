...
//     // Set timeout to remove the dot if not clicked within 800ms
//     const timeout = setTimeout(() => {
//       setDots((prevDots) => prevDots.filter((dot) => dot.id !== newDot.id));
//     }, 800);
...
//     setScore(0);
//     setDots([]);
//     setTimer(5); // Reset timer to 5 minutes
//   };
...
//   const [isNextEnabled, setIsNextEnabled] = useState(false); // Default to false
//   const [openModal, setOpenModal] = useState(false); // Modal state

//   // State for easy medium and hard
...
//       setDots((prevDots) => prevDots.filter((dot) => dot.id !== id));
//       clearTimeout(dotTimeout);
//     }, 800); // Wait for the animation to finish before removing the dot
//   };
...
//   const handleClickNext = () => {
//     if (!isGameActive) {
//       setOpenModal(true); // Open modal on Next click
//       setTimeout(() => {
//         setOpenModal(false); // Close modal after 3 seconds
...
//       {level === 1 && (
//         <Container>
//           <Button variant="outlined" color="success" onClick={handleClickEasy}>
//             easy
//           </Button>
//           <Button
//             variant="outlined"
...
//             Medium
//           </Button>
//           <Button variant="outlined" onClick={handleClickHard}>
//             Hard
//           </Button>
//         </Container>
//       )}

//       {level === 2 && (isEasy || isMedium || isHard) && (
//         <Container>
//           <Box sx={{ marginTop: "20px" }}>
//             <Box
//               sx={{
